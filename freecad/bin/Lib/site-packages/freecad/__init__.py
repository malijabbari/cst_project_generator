try:
    ...
    try:
        ...
        _path_to_freecad_libdir = "C:/Users/travis/build/FreeCAD/FreeCAD-AppImage/conda/win_dev/fc_env/Library/bin"
        print("PATH_TO_FREECAD_LIBDIR not specified, using default \
FreeCAD version in {}".format("C:/Users/travis/build/FreeCAD/FreeCAD-AppImage/conda/win_dev/fc_env/Library/bin"))
